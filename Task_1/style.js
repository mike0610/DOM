...
let listItem_0 = [listItem[0].textContent]
let listItem_4 = [listItem[4].textContent]
let listItem_1 = [listItem[1].textContent]
let listItem_3 = [listItem[3].textContent]
let listItem_2 = [listItem[2].textContent]

const listItem_5 = listItem_0 + ', ' + listItem_4 + ', '
	+ listItem_1 + ', ' + listItem_3 + ', ' + listItem_2;
...
let listItems = [list[0].innerText + ', ' + list[4].innerText + ', '
	+ list[1].innerText + ', ' + list[3].innerText + ', ' + list[2].innerText];

let listItems_str = listItems.toString();
console.log(listItems_str);
*/
